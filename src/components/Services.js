                    ...
                    <div className="row gy-4">
                        <div className="col-lg-4 col-md-6" data-aos-delay={100}>
                            <div className="service-item item-cyan position-relative">
                                ...
                                <p>Build dynamic, scalable, and responsive web applications using the MERN (MongoDB, Express, React, Node.js) stack from scratch.</p>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6" data-aos-delay={200}>
                            <div className="service-item item-orange position-relative">
                                ...
                                <h3>REST API & Backend Development</h3>
                                <p>Design and implement secure, efficient RESTful APIs and server-side logic using Express.js and Node.js.</p>
                        ...
                        <div className="col-lg-4 col-md-6" data-aos-delay={300}>
                            <div className="service-item item-teal position-relative">
                                ...
                                <p>Develop interactive and user-friendly UIs using React.js with optimized state management and component architecture.</p>
                            </div>
                        </div>{/* End Service Item */}
                        <div className="col-lg-4 col-md-6" data-aos-delay={400}>
                            <div className="service-item item-red position-relative">
                                ...
                                <p>Create, manage, and integrate MongoDB databases with backend services for seamless data handling.</p>
                        ...
                        <div className="col-lg-4 col-md-6" data-aos-delay={500}>
                            <div className="service-item item-indigo position-relative">
                                ...
                                <p>Implement secure authentication using JWT, OAuth, and best practices to protect your web applications.</p>
                            </div>
                        </div>{/* End Service Item */}
                        {/* <div className="col-lg-4 col-md-6" data-aos-delay={600}>
                            <div className="service-item item-pink position-relative">
                                ...
                                <p>Deploy MERN stack applications on platforms like Heroku, Vercel, or AWS, and provide ongoing support and updates.</p>
                            </div>
                        </div> */}
                    </div>
                </div>
